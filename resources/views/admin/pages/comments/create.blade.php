    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="postTitle" name="title" placeholder="Enter a post title." value="{{ old('title') }}">
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="postContent"></textarea>
                @error('content')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('summary') is-invalid @enderror" name="summary" id="postSummary" rows="3"></textarea>
                @error('summary')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
